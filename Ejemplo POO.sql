...
INSERT INTO EMPLEADO (NOMBRE, EDAD, SALARIO) 
VALUES ('Carlos Sánchez', 43, 12345.67);
...
INSERT INTO GERENTE (NOMBRE, EDAD, SALARIO, DEPARTAMENTO)
VALUES ('Uriel', 43, 12345.67, 'Desarrollo');

SELECT NOMBRE, EDAD, SALARIO, DEPARTAMENTO FROM GERENTE;
